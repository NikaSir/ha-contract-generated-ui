...
- `docs/NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md` — canonical v1.6 Header, native-scroll/zoom, stable-rendering, optional connection-indicator, typography, Bottom Tab Bar and brand contract;
