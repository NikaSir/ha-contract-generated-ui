...
> **HISTORICAL FIELD NOTES:** the normative result is `NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md` v1.7. Earlier native-overflow/CSS-zoom or transform-pan-at-100% experiments are not requirements.
