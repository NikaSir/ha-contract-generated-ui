...
Canonical requirements are in `NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md` v1.7.
...
- v1.7 is the sole normative shell/zoom/Header/source-return/navigation/typography/indicator/stable-rendering/brand source.
