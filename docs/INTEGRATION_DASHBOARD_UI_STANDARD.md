...
> **SUPERSEDED FOR SHELL/ZOOM/NAVIGATION:** `NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md` v2.2 is normative. Domain guidance below remains valid only where it does not conflict with v2.2.
