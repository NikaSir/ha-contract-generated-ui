...
- the plaque copies LIDER exactly: `min-width:min(290px,100%)`, `min-height:44px`, `padding:5px 14px`, `16px` radius, primary mixes `5%/24%` and shadow `0 5px 16px rgba(23,45,76,.06)`; pressed mixes are `13%/42%` with `0 2px 7px rgba(23,45,76,.05)`;
