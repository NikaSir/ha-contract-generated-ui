...
HOUSE_HERO_BUILD = "b002"
HOUSE_HERO_MODULE_URL = f"{HOUSE_HERO_STATIC_PATH}?build={HOUSE_HERO_BUILD}"
HOUSE_HERO_ASSET_FILENAME = "house-hero-dusk-v1.svg"
HOUSE_HERO_ASSET_STATIC_PATH = f"/{DOMAIN}/frontend/assets/{HOUSE_HERO_ASSET_FILENAME}"
HOUSE_HERO_ASSET_BUILD = "0300b001"
HOUSE_HERO_ASSET_URL = f"{HOUSE_HERO_ASSET_STATIC_PATH}?build={HOUSE_HERO_ASSET_BUILD}"
