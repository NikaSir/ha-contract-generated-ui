...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry[ContractGeneratedUICoordinator]) -> bool:
    ...
    from .const import (
        ...
        ROOMS_DIAGNOSTICS_FILENAME,
        ROOMS_DIAGNOSTICS_MODULE_URL,
        ROOMS_DIAGNOSTICS_STATIC_PATH,
        ROOMS_EQUIPMENT_FILENAME,
        ROOMS_EQUIPMENT_MODULE_URL,
        ROOMS_EQUIPMENT_STATIC_PATH,
        ROOMS_LIVE_FILENAME,
        ROOMS_LIVE_MODULE_URL,
        ROOMS_LIVE_STATIC_PATH,
        SOURCE_DIRECTORY,
    ...
    if not domain_data.get(FRONTEND_STATIC_REGISTERED):
        ...
        await hass.http.async_register_static_paths([
            ...
            StaticPathConfig(ROOMS_DIAGNOSTICS_STATIC_PATH, str(frontend_root / ROOMS_DIAGNOSTICS_FILENAME), False),
    ...
    add_extra_js_url(hass, ROOMS_DIAGNOSTICS_MODULE_URL)
