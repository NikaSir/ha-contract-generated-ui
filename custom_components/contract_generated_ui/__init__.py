...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry[ContractGeneratedUICoordinator]) -> bool:
    ...
    from .const import (
        APP_SHELL_FILENAME, APP_SHELL_STATIC_PATH, DOMAIN, FRONTEND_DIRECTORY, FRONTEND_STATIC_REGISTERED,
        GENERATED_DIRECTORY, GENERATED_SUBPANEL_FILENAME, GENERATED_SUBPANEL_STATIC_PATH,
        HOUSE_HERO_ASSETS_STATIC_PATH, HOUSE_HERO_FILENAME, HOUSE_HERO_MODULE_URL, HOUSE_HERO_STATIC_PATH,
        HOUSE_PANEL_FILENAME, HOUSE_PANEL_STATIC_PATH, INFRASTRUCTURE_PANEL_FILENAME, INFRASTRUCTURE_PANEL_STATIC_PATH,
        INFRA_SUMMARY_FILENAME, INFRA_SUMMARY_STATIC_PATH, NAVIGATION_REGISTRY_FILENAME, NAVIGATION_REGISTRY_STATIC_PATH,
        PANEL_ZOOM_FILENAME, PANEL_ZOOM_MODULE_URL, PANEL_ZOOM_STATIC_PATH,
        ROOMS_EQUIPMENT_FILENAME, ROOMS_EQUIPMENT_MODULE_URL, ROOMS_EQUIPMENT_STATIC_PATH,
        ROOMS_LIVE_FILENAME, ROOMS_LIVE_MODULE_URL, ROOMS_LIVE_STATIC_PATH,
        SOURCE_DIRECTORY, SPECIALIZED_SHELL_FILENAME, SPECIALIZED_SHELL_MODULE_URL, SPECIALIZED_SHELL_STATIC_PATH,
        UI_BUNDLE_FILENAME, UI_BUNDLE_MODULE_URL, UI_BUNDLE_STATIC_PATH,
    )
    from .coordinator import ContractGeneratedUICoordinator
    ...
    if not domain_data.get(FRONTEND_STATIC_REGISTERED):
        ...
        await hass.http.async_register_static_paths([
            ...
            StaticPathConfig(ROOMS_LIVE_STATIC_PATH, str(frontend_root / ROOMS_LIVE_FILENAME), False),
    ...
    add_extra_js_url(hass, ROOMS_LIVE_MODULE_URL)
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry[ContractGeneratedUICoordinator]) -> bool:
    ...
    from homeassistant.const import Platform
    from .const import HOUSE_HERO_MODULE_URL, PANEL_ZOOM_MODULE_URL, ROOMS_EQUIPMENT_MODULE_URL, ROOMS_LIVE_MODULE_URL, SPECIALIZED_SHELL_MODULE_URL, UI_BUNDLE_MODULE_URL
    ...
    if unloaded:
        ...
        for module_url in (UI_BUNDLE_MODULE_URL, ROOMS_EQUIPMENT_MODULE_URL, ROOMS_LIVE_MODULE_URL, PANEL_ZOOM_MODULE_URL, SPECIALIZED_SHELL_MODULE_URL, HOUSE_HERO_MODULE_URL):
            try:
