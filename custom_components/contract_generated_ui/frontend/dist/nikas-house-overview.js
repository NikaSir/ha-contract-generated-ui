      ...
      this.shadowRoot.innerHTML = `
        <style>
          ...
          *{box-sizing:border-box}
          ...
          .heading strong{font-size:21px;font-weight:800;letter-spacing:-.02em}
          .heading span{margin-top:3px;font-size:12px;font-weight:560;line-height:1.2;color:var(--secondary-text-color,#6b7280)}
          ...
          @media(max-width:390px){.header{grid-template-columns:48px minmax(0,1fr) 48px;min-height:60px}.tab{padding-left:2px;padding-right:2px}.work-canvas{margin:7px 9px 8px}.canvas-viewport.zoomed .work-canvas{left:9px;right:9px;top:7px;margin:0}}
