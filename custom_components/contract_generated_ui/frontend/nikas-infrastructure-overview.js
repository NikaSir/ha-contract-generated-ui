  ...
  class NikasInfrastructureOverview extends HTMLElement {
      ...
      this.shadowRoot.innerHTML = `
        <style>
          ...
          *{box-sizing:border-box}
          ...
          .tab ha-icon{--mdc-icon-size:25px;width:25px;height:25px}.tab span{display:block;width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:center;font-size:12px;line-height:16px;font-weight:600}
    ...
    _beginPinch() {
      ...
      this._pinch = {
        ...
        contentY: (localY - this._state.y) / this._state.scale,
