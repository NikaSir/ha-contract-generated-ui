...
SNAPSHOT_DOWNLOAD_URL = "/api/contract_generated_ui/registry_snapshot"
...
class RegistrySnapshotDownloadView(HomeAssistantView):
    ...
    name = "api:contract_generated_ui:registry_snapshot"
    requires_auth = True
    ...
    async def get(self, request: web.Request) -> web.StreamResponse:
        ...
        return web.FileResponse(
            ...
            headers={
                ...
                "Content-Disposition": 'attachment; filename="contract-generated-ui-registry-current.json"',
...
def async_register_snapshot_download_view(hass: HomeAssistant) -> None:
    ...
    key = "contract_generated_ui_snapshot_download_view_registered"
